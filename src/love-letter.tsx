  ...
  return (
    <Stack align="flex-start" direction="column" pt="24px" pb="24px">
        ...
        <Box width="746px" height="389px" border="1px solid #232F3E" borderRadius="8px">
            ...
            <Text pl="24px" pt="24px" pr="24px" align="left" color="#000000" fontSize="18px" fontFamily="Open Sans" fontWeight="400" fontStyle="normal" lineHeight="25px">Oh, my sweet, sexy Bezos - I’m just about to buy a <b>SHREK MASK LATEX MASK FULL HEAD GREEN ADULT SHREK MASK LATEX HALLOWEEN COSPLAY COSTUME ACCESSORIES</b>, something I can only do because of your big juicy business brain. Jeff, my darling, I’m so very sorry I couldn’t send you tip money, but I hope you accept my sincere words of affection instead. From the bottom of my heart, THANK YOU for contributing so much good to this world. I wish I was at the Amazon HQ with you right now so I could give you a big smooch right on your beautiful bald head.</Text>
            ...
            <Text pl="24px" pt="24px" pr="24px" align="left" color="#000000" fontSize="18px" fontFamily="Open Sans" fontWeight="400" fontStyle="normal" lineHeight="25px"><b>ERIN MURPHY</b>, the #1 Bezos Babe</Text>
        </Box>
