...
function LoveLetter(props: any) {
    let letterContent = "{Dear Daddy Bezos + props.getPersonName}"
  ...
  return (
    <Stack align="flex-start" direction="column" pt="24px" pb="24px">
        ...
        <Box width="746px" height="389px" border="1px solid #232F3E" borderRadius="8px">
            ...
            <Text pl="24px" pt="24px" pr="24px" align="left" color="#000000" fontSize="18px" fontFamily="Open Sans" fontWeight="400" fontStyle="normal" lineHeight="25px">Oh, my sweet, sexy Bezos - I’m just about to buy a <b>{props.getPurchase.toUpperCase()}</b>, something I can only do because of your big juicy business brain. Jeff, my darling, I’m so very sorry I couldn’t send you tip money, but I hope you accept my sincere words of affection instead. From the bottom of my heart, THANK YOU for contributing so much good to this world. I wish I was at the Amazon HQ with you right now so I could give you a big smooch right on your beautiful bald head.</Text>
            ...
            <Text pl="24px" pt="24px" pr="24px" align="left" color="#000000" fontSize="18px" fontFamily="Open Sans" fontWeight="400" fontStyle="normal" lineHeight="25px"><b>{props.getPersonName.toUpperCase()}</b>, the #1 Bezos Babe</Text>
        </Box>
        ...
        Back to tip options
            ...
            <Button onClick={() => {
                props.setIsConfetti(true); 
                window.parent.postMessage("FADE OUT", "*");

            }} backgroundColor="#232F3E" borderColor="#232F3E" borderWidth="1px" fontSize="20px" fontStyle="normal" fontFamily="Open Sans" fontWeight="600" color="#FFFFF" width="361px" height="68px" left="0px" top="0px">
        Send letter
            </Button>
        </Stack>
    </Stack>
